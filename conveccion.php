...
<?php		
		...
		{
			if ($_POST["boton_menu1"] == "Conveccion")
			{
...
?>
			<form action="conveccioncálculo.php" method="POST">
				...
				<div align="center">
				<br>
					<input type="radio" name="group1" value="m"> m<br>
					<input type="radio" name="group1" value="Vp"> Vp<br>
					...
					<input type="radio" name="group1" value="Tfinal" checked> T final<br>
				<hr>
